...
imgBackground = cv2.imread("C:\\Users\\jones\\Downloads\\face_recognition_flask-main\\background.png")

datetoday = date.today().strftime("%m_%d_%y")
datetoday2 = date.today().strftime("%d-%B-%Y")

face_detector = cv2.CascadeClassifier('C:\\Users\\jones\\Downloads\\face_recognition_flask-main\\haarcascade_frontalface_default.xml')

# Add your Google Sheets credentials JSON file path
CREDENTIALS_FILE = 'C:\\Users\\jones\\Downloads\\face_recognition_flask-main\\tough-ivy-422315-h4-e95dd47b045f.json'
...
def add_attendance_to_sheet(name, userid, latitude, longitude):
    ...
    current_time = datetime.now().strftime("%H:%M:%S")
    office_latitude = 9.6894536  # Replace with your office latitude
    office_longitude =  78.4581123# Replace with your office longitude
